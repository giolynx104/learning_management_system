...
class RollCallScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    debugPrint('RollCallManagementScreen - Build started');
    
    try {
      final classInfo = useState<ClassDetailModel?>(null);
      debugPrint('RollCallManagementScreen - useState initialized');
      ...
      debugPrint('RollCallManagementScreen - Error in build: $e');
      debugPrint('RollCallManagementScreen - Stack trace: $stackTrace');
      return Scaffold(
        body: Center(
